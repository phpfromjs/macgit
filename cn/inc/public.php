...
function get_chapter($ID,$table,$ClassID='')
{
    ...
    if( mysql_num_rows( $result ) )
    {
        ...
        $html.= " <a href='$url?id=".$rs['id']."' >上一个：".cut_str($rs['title'], 15, $dot = '...')."</a>";
    }
    else
    {
        $html .= "<a href='javascript:void(0);'>上一个：暂无</a>";
    }
    ...
    {
        $rs = mysql_fetch_array( $result );
        $html .= "<a  href='$url?id=".$rs['id']."'>下一个：".cut_str($rs['title'], 15, $dot = '...')."</a>";
    }
    else
    {

        $html .= "<a  href='javascript:void(0);'>下一个：暂无</a>";
