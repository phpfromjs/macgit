...
//        $sFile3 = $sFile."/cn/about/index.php?id=".$title['id']."&classname=123";
        $sFile3 = $sFile."/cn/about/index.php?classname=123";
        $tFile4 = "/cn/about/index.php";
...
//    if ($p == 1)
//    {
        $sFile3 = $sFile."/en/about/index.php?classname=123";
        $tFile4 = "/en/about/index.php";
        $shtml->create_html($sFile3, $tFile4);
//    }
//    $p++;
//    $i++;
...
<div class="chenggong">
    ...
    <div class="cg_right"><h1>(关于我们)</h1><p>生成静态栏目成功!</p></div>
</div>
</body>
</html>