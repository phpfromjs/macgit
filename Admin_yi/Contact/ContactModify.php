...
if (!empty($_GET['pID']))
{
    $id = $_GET['pID'];
    $page = $_GET['page'];
    $sql = "SELECT * FROM ".$data['contact']." WHERE id='$id' AND qy=".$_SESSION['qy']."";
...
<div class="formbody">
    ...
    <form method="post" name="myform" onSubmit="return CheckForm();" action="ContactSave.php?action=Modify">
    <ul class="forminfo">
        ...
        <li ><label>栏目名称</label><input name="title_en" id="title_en" type="text" class="dfinput" value="<?php echo $res['title_en'];?>" /><i>（英文）</i></li>
        <li><label>公司名称</label><input type="text" id="CompanyNameCn" name="CompanyNameCn" value="<?php echo $res['CompanyNameCn'];?>" class="dfinput" /><i>（中文）</i></li>
        <li><label>公司名称En</label><input type="text" id="CompanyNameEn" name="CompanyNameEn" value="<?php echo $res['CompanyNameEn'];?>" class="dfinput" /><i>（英文）</i></li>
        <li><label>栏目摘要</label><textarea id="text" name="text" cols="" rows="" class="textinput"><?php echo $res['text'];?></textarea><i>（中文）</i></li>
        <li ><label>栏目摘要</label><textarea id="text_en" name="text_en" cols="" rows="" class="textinput"><?php echo $res['text_en'];?></textarea><i>（英文）</i></li>
        <li>
            <label>二维码</label>
        ...
        <li >
            ...
            <iframe id="UploadFiles" src="../upfile/upload.php?formname=myform&editname=spicen&uppath=pic&filelx=jpg" frameborder="0" scrolling="No" width="280" height="30" style="top:2px;"></iframe>
            <i>
                <?php
                if ($res['spicen'] != "")
                {
        ...
        <li><label>地址</label><input type="text" id="Addressen" name="Addressen" value="<?php echo $res['Addresswn'];?>" class="dfinput" /><i>（英文）</i></li>
        <li><label>移动电话1</label><input type="text" id="mobilephone1" name="mobilephone1" value="<?php echo $res['mobilephone1'];?>" class="dfinput" /><i>（中文）</i></li>
        <li><label>移动电话1</label><input type="text" id="mobilephoneen1" name="mobilephoneen1" value="<?php echo $res['mobilephoneen1'];?>" class="dfinput" /><i>（英文）</i></li>
        <li><label>移动电话2</label><input type="text" id="mobilephone2" name="mobilephone2" value="<?php echo $res['mobilephone2'];?>" class="dfinput" /><i>（中文）</i></li>
        <li><label>移动电话2</label><input type="text" id="mobilephoneen2" name="mobilephoneen2" value="<?php echo $res['mobilephoneen2'];?>" class="dfinput" /><i>（英文）</i></li>
        <li><label>固定电话</label><input type="text" id="TelePhone" name="TelePhone" value="<?php echo $res['TelePhone'];?>" class="dfinput" /><i>（中文）</i></li>
        <li><label>固定电话</label><input type="text" id="TelePhoneen" name="TelePhoneen" value="<?php echo $res['TelePhoneen'];?>" class="dfinput" /><i>（英文）</i></li>
        <li style="display: none"><label>传真</label><input type="text" id="Fax" name="Fax" value="<?php echo $res['Fax'];?>" class="dfinput" /><i>（中文）</i></li>
        ...
        <li style="display: none"><label>邮政编码</label><input type="text" id="postalcodecn" name="postalcodecn" value="<?php echo $res['postalcodecn'];?>"class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>邮政编码</label><input type="text" id="postalcodeen" name="postalcodeen" value="<?php echo $res['postalcodeen'];?>"class="dfinput" /><i>（英文）</i></li>
        ...
        <li style="display: none"><label>工作时间</label><input type="text" id="worktimecn" name="worktimecn" value="<?php echo $res['worktimecn'];?>"class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>工作时间</label><input type="text" id="worktimeen" name="worktimeen" value="<?php echo $res['worktimeen'];?>"class="dfinput" /><i>（英文）</i></li>
        <li><label>经度</label><input type="text" id="Longitude" name="Longitude" value="<?php echo $res['Longitude'];?>" class="dfinput" /><i>（中文）</i></li>
        <li><label>纬度</label><input type="text" id="Latitude" name="Latitude" value="<?php echo $res['Latitude'];?>" class="dfinput" /><i>（中文）</i></li>
        ...
        <li style="display: none"><label>栏目内容<i><br />（中文）</i></label><textarea id="content" name="content" cols="" rows="" class="textinput2"><?php echo $res['content'];?></textarea></li>
