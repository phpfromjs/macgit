...
?>
<?php
$sql = "SELECT * FROM ".$data['pro']." ORDER BY sort DESC";
...
<div class="formbody">
    ...
    <form method="post" name="myform" onSubmit="return CheckForm();" action="ProductSave.php?action=add" target="_self">
    <ul class="forminfo">
        ...
        <li><label>产品简介</label><textarea id="text" name="text" cols="" rows="" class="textinput"></textarea><i>（中文）</i></li>
        <li ><label>产品简介</label><textarea id="text_en" name="text_en" cols="" rows="" class="textinput"></textarea><i>（英文）</i></li>
        <li style="display: none"><label>价格</label><input type="text" id="price" name="price" value="" class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>价格</label><input type="text" id="price1" name="price1" value="" class="dfinput"  /><i>（英文）</i></li>
        <li ><label>发布者：</label><input type="text" id="chandi" name="chandi" value="" class="dfinput" /><i>（中文）</i></li>
        <li ><label>发布者：</label><input type="text" id="chandien" name="chandien" value="" class="dfinput"  /><i>（英文）</i></li>
        <li style="display: none"><label>材质/规格</label><input type="text" id="caizhi" name="caizhi" value="" class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>材质/规格</label><input type="text" id="caizhien" name="caizhien" value="" class="dfinput"  /><i>（英文）</i></li>
