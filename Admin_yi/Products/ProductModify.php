...
if (!empty($_GET['pID']))
{
    $id = $_GET['pID'];
    $page = $_GET['page'];
    $sql = "SELECT * FROM ".$data['pro']." WHERE id='$id'";
...
<div class="formbody">
    ...
    <form method="POST" name="myform" onSubmit="return CheckForm();" action="ProductSave.php?action=Modify">
    <ul class="forminfo">
        ...
        <li ><label>产品简介</label><textarea id="text_en" name="text" cols="" rows="" class="textinput"><?php echo $res['text'];?></textarea><i>（中文）</i></li>
        <li ><label>产品简介</label><textarea id="text_en" name="text_en" cols="" rows="" class="textinput"><?php echo $res['text_en'];?></textarea><i>（英文）</i></li>
        <li style="display: none"><label>价格</label><input type="text" id="price" name="price" value="<?php echo $res['price'];?>" class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>价格</label><input type="text" id="price1" name="price1" value="<?php echo $res['price1'];?>" class="dfinput" /><i>（英文）</i></li>
        <li ><label>发布者</label><input type="text" id="chandi" name="chandi" value="<?php echo $res['chandi'];?>" class="dfinput" /><i>（中文）</i></li>
        <li ><label>发布者</label><input type="text" id="chandien" name="chandien" value="<?php echo $res['chandien'];?>" class="dfinput"  /><i>（英文）</i></li>
        <li style="display: none"><label>材质/规格</label><input type="text" id="caizhi" name="caizhi" value="<?php echo $res['caizhi'];?>" class="dfinput" /><i>（中文）</i></li>
        <li style="display: none"><label>材质/规格</label><input type="text" id="caizhien" name="caizhien" value="<?php echo $res['caizhien'];?>" class="dfinput"  /><i>（英文）</i></li>
        <li>
            <label>缩略图</label>
        ...
        <li style="display: none">
            ...
            <i>
                ...
                {
                ?>
                <a href="javascript:;" onMouseOver="document.getElementById('pic3').style.display='block';" onMouseOut="document.getElementById('pic3').style.display='none';">图片已上传</a>&nbsp;&nbsp;[<a href="ProFileDel.php?id=<?php echo $res['id'];?>&fld=bpic" style="color:#FF0000;">删除</a>]
        ...
        <li style="display: none">
            ...
            <i>
                ...
                {
                    ?>
                    <a href="javascript:;" onMouseOver="document.getElementById('pic4').style.display='block';" onMouseOut="document.getElementById('pic4').style.display='none';">图片已上传</a>&nbsp;&nbsp;[<a href="ProFileDel.php?id=<?php echo $res['id'];?>&fld=bpicen" style="color:#FF0000;">删除</a>]
