...
?>
<?php
$sql = "SELECT * FROM ".$data['link']." WHERE qy=".$_SESSION['qy']." ORDER BY sort DESC";
...
<div class="formbody">
    <div class="formtitle"><span>友情链接</span></div>
    <form method="post" name="myform" action="LinkSave.php?action=add" onSubmit="return CheckForm();" target="_self">
    <ul class="forminfo">
        ...
        <li><label>链接名称</label><input type="text" id="title" name="title" class="dfinput" /><i>（中文）</i></li>
        <li ><label>链接名称</label><input type="text" id="title_en" name="title_en" class="dfinput" /><i>（英文）</i></li>
        <li><label>链接地址</label><input type="text" id="linkurl" name="linkurl" class="dfinput" /><i>（中文）</i></li>
        <li><label>链接地址</label><input type="text" id="linkurlen" name="linkurlen" class="dfinput" /><i>（英文）</i></li>
