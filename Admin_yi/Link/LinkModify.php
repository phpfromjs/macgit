...
if (!empty($_GET['pID']))
{
    $id = $_GET['pID'];
    $page = $_GET['page'];
    $sql = "SELECT * FROM ".$data['link']." WHERE id='$id' AND qy=".$_SESSION['qy']."";
...
<div class="formbody">
    ...
    <form method="post" name="myform" onSubmit="return CheckForm();" action="LinkSave.php?action=Modify">
    <ul class="forminfo">
        ...
        <li><label>链接地址</label><input type="text" id="linkurlen" name="linkurlen" value="<?php echo $res['linkurlen'];?>" class="dfinput" /><i>（英文）</i></li>
