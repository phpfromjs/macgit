...
?>
<?php
$sql = "SELECT * FROM ".$data['about']." ORDER BY sort DESC";
...
<div class="formbody">
    ...
    <form method="post" name="myform" onSubmit="return CheckForm();" action="AboutSave.php?action=add" target="_self">
    <ul class="forminfo">
        ...
        <li><label>文章名称</label><input name="title" id="title" type="text" class="dfinput" /><i>（中文）</i></li>
        <li ><label>文章名称</label><input name="title_en" id="title_en" type="text" class="dfinput" /><i>（英文）</i></li>
        <li style="display: none"><label>图片链接</label><input name="model" id="model" type="text" class="dfinput" /><i></i></li>
        ...
        <li ><label>图片</label><input name="spicen" id="spicen" type="hidden" class="dfinput" /><iframe style="top:2px" id="UploadFiles" src="../upfile/upload.php?formname=myform&editname=spicen&uppath=pic&filelx=jpg" frameborder="0" scrolling="No" width="280" height="30"></iframe><i>英文</i></li>
        <li><label>文章摘要</label><textarea id="text" name="text" cols="" rows="" class="textinput"></textarea><i>（中文）</i></li>
        <li><label>文章摘要</label><textarea id="text_en" name="text_en" cols="" rows="" class="textinput"></textarea><i>（英文）</i></li>
        <li><label>文章内容<i><br />（中文）</i></label><textarea id="content" name="content" cols="" rows="" class="textinput2"></textarea></li>
        <li ><label>文章内容<i><br />（英文）</i></label><textarea id="content_en" name="content_en" cols="" rows="" class="textinput2"></textarea></li>
