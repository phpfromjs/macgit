...
?>
<?php
$sql = "SELECT * FROM ".$data['picture']." ORDER BY sort DESC";
...
<div class="formbody">
    ...
    <form method="post" name="myform" onSubmit="return CheckForm();" action="PictureSave.php?action=add" target="_self">
    <ul class="forminfo">
        ...
        <li ><label>图片链接</label><input name="model" id="model" type="text" class="dfinput" /><i>（中文）</i></li>
        <li ><label>图片链接</label><input name="modelen" id="modelen" type="text" class="dfinput" /><i>（英文）</i></li>
