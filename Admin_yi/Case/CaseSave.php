...
if (!empty($_GET['action']))
{
    ...
    switch($action)
    {
        case "add";
            ...
            $sql = "SELECT * FROM ".$data['classcase']." WHERE classid=".$cid;
