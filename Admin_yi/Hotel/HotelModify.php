...
if (!empty($_GET['pID']))
{
    $id = $_GET['pID'];
    $page = $_GET['page'];
    $sql = "SELECT * FROM ".$data['hotel']." WHERE id='$id'";
...
<div class="formbody">
    ...
    <form method="POST" name="myform" onSubmit="return CheckForm();" action="HotelSave.php?action=Modify">
    <ul class="forminfo">
        ...
        <li style="display:none;"><label>栏目名称</label><input type="text" id="title_en" name="title_en" value="<?php echo $res['title_en'];?>" class="dfinput" /><i>（英文）</i></li>
        <li style="display:none;"><label>栏目型号</label><input type="text" id="model" name="model" value="<?php echo $res['model'];?>" class="dfinput" /><i></i></li>
        ...
        ?>
        <li style="display:none;"><label>栏目参数</label><textarea id="text" name="text" cols="" rows="" class="textinput"><?php echo $res['text'];?></textarea><i>（中文）</i></li>
        <li style="display:none;"><label>栏目参数</label><textarea id="text_en" name="text_en" cols="" rows="" class="textinput"><?php echo $res['text_en'];?></textarea><i>（英文）</i></li>
        <li><label>栏目详情<i><br />（中文）</i></label><textarea id="content" name="content" cols="" rows="" class="textinput2"><?php echo $res['content'];?></textarea></li>
        <li style="display:none;"><label>栏目详情<i><br />（英文）</i></label><textarea id="content_en" name="content_en" cols="" rows="" class="textinput2"><?php echo $res['content_en'];?></textarea></li>
        <li><b>SEO信息设置</b></li>
