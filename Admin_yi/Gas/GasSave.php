...
if (!empty($_GET['action']))
{
    ...
    switch($action)
    {
        ...
        case "add";
            ...
            $cid = $_POST['classid'];
            $sql = "SELECT * FROM ".$data['classgas']." WHERE classid=".$cid;
        ...
        case "Modify";
            ...
            $string = "UPDATE ".$data['gas']." SET classid='$cid',bid='$cidd',author='$author',author_en='$author_en',hits='$hits',title='$title',title_en='$title_en',content='$content',content_en='$content_en',spic='$spic',bpic='$bpic',sort='$sort',tj='$tj',passed='$passed',addTime='$addTime',text='$text',text_en='$text_en',tpid='$tpid',t='$t',t_en='$t_en',k='$k',k_en='$k_en',d='$d',d_en='$d_en',isnew='$isnew' WHERE id=".$pid;
            mysql_query($string, $conn) or die("ERROR: ".mysql_error());
            header("Location:GasList.php");
            exit;
            break;
