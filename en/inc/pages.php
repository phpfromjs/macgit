...
class Pager
{
    ...
    function Pager($num_row, $pagesize, $page)
    {
        ...
        echo ' <ul class="yema">';
        echo '<li class="first"><a href="'.$this->getUrl($startNum).'">home page</a></li>';
        if ($page > 1)
        {
            echo '<li><a href="'.$this->getUrl($page-1).'"> previous page</a></li>';
        }
        else
        {
            echo '<li><a href="#">previous page</a></li>';
        }
        ...
        if ($page < $AllNum)
        {
            echo '<li><a href="'.$this->getUrl($page+1).'"> trailer page </a></li>';
        }
        else
        {
            echo '<li><a href="#">trailer page</a></li>';
        }
        echo '<li class="last"><a href="'.$this->getUrl( $endNum).'">next page </a></li>';
        echo '</ul>';
