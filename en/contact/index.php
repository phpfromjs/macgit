...
<html>
    ...
    <?php include('../inc/header.php');?>
		<!--主体内容-->
		<div class="banner4" style="background: url(<?php echo "../../".$banner['spicen'];?>)no-repeat center"></div>
		<div class="detail">
			<div class="container">
				<div class="left">
					...
					<p class="nynav">
						...
						<a href="index.php" class="a2">CONTACT</a>
					</p>
				...
				<div class="right">
					...
					<div class="map">
						<div class="erweima">
							<img src="../../<?php echo $contact['spicen'];?>" />
							<div class="text">
								<p class="p1"><?php echo $contact['CompanyNameEn'];?></p>
								<p class="p2"><?php echo $contact['text_en'];?></p>
							</div>
						</div>
						<ul>
							<li>
								...
								<p class="p2"><?php echo $contact['Addressen'];?></p>
							</li>
							<li>
								<img src="../images/icon18.png" />
								<p class="p1">MOBILEPHONE</p>
								<p class="p2"><?php echo $contact['mobilephoneen1'];?></p>
								<p class="p2"><?php echo $contact['mobilephoneen2'];?></p>
							</li>
							<li>
								<img src="../images/icon19.png" />
								<p class="p1">TELEPHONE</p>
								<p class="p2"><?php echo $contact['TelePhoneen'];?></p>
							</li>
							<li>
								<img src="../images/icon20.png" />
								<p class="p1">EMAIL</p>
								<p class="p2"><?php echo $contact['emailen'];?></p>
							</li>
						</ul>
					</div>
    ...
    <?php include("../inc/footer.php"); ?>
		<script type="text/javascript">
			...
			//标注点数组
			var markerArr = [{
				title: "<?php echo $contact['CompanyNameEn'];?>",
				content: "ADDRESS：<?php echo $contact['Addressen'];?><br/>TELEPHONE：<?php echo $contact['TelePhoneen'];?>",
